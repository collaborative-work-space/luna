...
class BaseDataset(Dataset):
    ...
    def __init__(self, root_dir, split, image_dim, max_depth, overfit=False, num_val_samples=8, load_depth=True, load_feat=False, instance_dir='filtered_pano_instance', semantics_dir='filtered_pano_sem',
    ...
    def load_sample(self, sample_index):
        ...
        image = Image.open(self.root_dir / "rgb" / f"{sample_index}.png")
